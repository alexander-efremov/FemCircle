...
double get_center_x_3() { return A + 0.5; }

double get_center_y_3() { return C + 0.7; }

inline static double func_u(double t, double x, double y) { return -y + 0.5; }

inline static double func_v(double t, double x, double y) { return x - 0.5; }

inline static double analytical_solution_circle(double t, double x, double y) {
    double x0 = get_center_x_3() + t * func_u(t, x, y);
    double y0 = get_center_y_3() + t * func_v(t, x, y);
